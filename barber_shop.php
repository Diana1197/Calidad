                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    <div class="top-right-contact text-right pull-right hidden-sm hidden-xs">
                                        <i class="fa fa-phone-square"></i> (+57) 3227709374)
                ...
                <ul>
                    ...
                    <li data-index="rs-3" data-transition="slideoververtical">
                        ...
                        <div class="tp-caption Photography-Display tp-resizeme" id="slide-3-layer-2" 
                            ...
                            style="z-index: 6; white-space: nowrap; font-family: Playfair Display;">CHIPHYSI PROGRAMACION</div>
                        ...
                        <div class="tp-caption Photography-Display tp-resizeme" id="slide-3-layer-3" 
                            ...
                            style="z-index: 7; white-space: nowrap; color: #bc9355; font-family: Playfair Display;">CHIPHYSI PROGRAMACION
                        </div>
                        ...
                        <div class="tp-caption rev-btn rev-bordered" id="slide-3-layer-4" 
                            ...
                            style="z-index: 8; white-space: nowrap; font-size: 14px; line-height: 15px; color: rgba(255, 255, 255, 1.00);font-family:Open Sans;background-color:rgba(0, 0, 0, 0);padding:13px 35px 13px 35px;border-color:rgba(255, 255, 255, 0.25);border-style:solid;border-width:2px;letter-spacing:1px;text-transform: uppercase;">Barberia
                        </div>
                    </li>
                </ul>
            </div>
                ...
                <div class="row mb30">
                    <div class="col-md-12">
                        <div class="footer-logo">
                            <img src="img/logo.png" alt="" class="img-center img-responsive">
                        </div>
                    </div>
                </div>
                <div class="row mb30">
                    <div class="col-md-5 col-sm-5">
                        <div class="footer-contact text-right">
                            <p>Telefono: +57 322 770 93 74</p>
                            <p>E-mail: <a href="http://sitetemplate.demo.ithemeslab.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="533a3d353c132a3c2621373c3e323a3d7d303c3e">LLamanos y contractanos para tus proyectos</a></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="footer-social">
                            <ul>
                                ...
                                <li><a href="https://www.linkedin.com/in/jhonatan-cardona-6199a4162/" target="_black"><i class="fa fa-linkedin"></i></a></li>
                                <li><a href="https://www.youtube.com/channel/UC87BrnQy7Y6iipGvQ6sAJfQ" target="_black"><i class="fa fa-google-plus"></i></a></li>
                                <li><a href="https://www.linkedin.com/in/jhonatan-cardona-6199a4162/" target="_black"><i class="fa fa-pinterest"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
